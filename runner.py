...
users_collection.create_index("bot")
...
def process_download(bot, chat_id, uid, url):
    ...
    try:
        ...
        if not result:
            return bot.send_message(chat_id, "❌ Failed to fetch")
